...
const SHAPES = ["kvadrat", "trokut", "pravokutnik", "krug"]
...
const QUESTIONS = {
    'boja pozadine' : (d) => d.colors['background'],
    'boja pozadine teksta' : (d) => d.colors['text'],
    'boja broja' : (d) => d.colors['number'],
    'boja oblika' : (d) => d.colors['shape'],
    'Boja Texta' : (d) => d.text[0],
    'oblik teksta' : (d) => d.text[1],
    'oblik' : (d) => d.shape
}
